...
class Order extends Common
{
    ...
    protected function getListByWhere($input, $isPage = true)
    {
        ...
        if (!empty($input['erp_id'])) {
            $where[] = ['u.erp_manage_id', 'in', (array)$input['erp_id']];
        }
...
//                }
    ...
    public static function exportHeader()
    {
        return [
            ...
            ['field' => 'erp_manage_name', 'desc' => '销售经理', 'type' => DataType::TYPE_STRING],
